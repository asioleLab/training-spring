...
import com.example.demo.BodyPut;
import com.example.demo.BodyRequestProva;
import com.example.demo.BodyResponseProva;
...
//    @PostMapping(path = "/prova")
    ...
    BodyResponseProva prova(@RequestBody BodyRequestProva breqp){
...
//    private @ResponseBody BodyPut put(@RequestParam(required = false,defaultValue = "0") String id){
    private @ResponseBody
    BodyPut put(@RequestBody BodyPut bp){
